...
| [Profile source library plan](docs/plans/2026-07-21-profile-source-library.md) | Plane blueprint for standalone `profile/` library (Phase 1 scaffold Done; ready for intake) |
